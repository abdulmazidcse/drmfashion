...
export default function LandingPageBuy({
  ...
  if (placed) {
    return (
      <div className="flex flex-col min-h-screen bg-white text-zinc-950">
        <Header />
        <main className="flex-1 flex flex-col items-center justify-center gap-8 px-6 py-20 text-center bg-zinc-50">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-zinc-950">
      ...
      <main className="flex-1 w-full max-w-[1100px] mx-auto px-5 py-10 lg:py-16">
        <div className="mb-10">
          <h1 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight leading-tight">{heading}</h1>

...
import { Settings, Loader2, Trash2, Image as ImageIcon, Sun, X, FileText, Film, LayoutGrid, Pencil, Plus, ArrowUp, ArrowDown, type LucideIcon } from "lucide-react"
...
import HeroSlidesCard from "./HeroSlidesCard"
  ...
  return (
    <div className="space-y-6 animate-in fade-in-50 duration-200">
        ...
        <CollapsibleCard
          ...
          description="Control the rotation timing, floating product card, and the slides themselves."
          icon={ImageIcon}
        >
